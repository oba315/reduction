...
{
    int e1, e2, f1, f2;
    return mycollapse::collapse_edge(e, p, V, F, E, EMAP, EF, EI, e1, e2, f1, f2);
}
    ...
    Eigen::VectorXd& weight)
{
    ...
    return
        mycollapse::collapse_edge(
            cost_and_placement, always_try, never_care,
            V, F, E, EMAP, EF, EI, Q, Qit, C, e, e1, e2, f1, f2, weight);
}
    ...
    )
{
    ...
    {
        collapsed = mycollapse::collapse_edge(e, C.row(e), V, F, E, EMAP, EF, EI, e1, e2, f1, f2);
    }
    else
    {
        ...
        for (auto n : N)
        {
                ...
                F(n, 2) != IGL_COLLAPSE_EDGE_NULL)
            {
                for (int v = 0; v < 3; v++)
                {
                    ...
                    mycollapse::shortest_edge_and_midpoint(ei, V, F, E, EMAP, EF, EI, cost, place, weight);
                    // Replace in queue
...
void mycollapse::shortest_edge_and_midpoint(
    const int e,
    const Eigen::MatrixXd& V,
    const Eigen::MatrixXi& /*F*/,
    const Eigen::MatrixXi& E,
